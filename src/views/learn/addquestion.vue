<template>
  <div>
    <p>
      <input class="content" placeholder="请输入提问" type="text" v-model="content" />
    </p>
    <p>
      <span class="btn" @click="addquestion()">提交问题</span>
    </p>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    addquestion() {
      ...
      this.axios
        .post("/api/b1/mobile/question/submit", {
          id: this.id,
          type: this.type,
